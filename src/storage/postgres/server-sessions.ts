...
export class PostgresServerSessionsRepository {
   ...
   * per-event lane normally finishes first, so the summary arrived at an empty
   * list and the model was asked to summarise nothing. Measured on the
   * patrykradek corpus 2026-09-19 — 441 of 738 completed summary jobs wrote
   * zero observations.
   */
