...
export class ServerClient {
  ...
  buildAddObservationPayload(
    ...
    //
    // Measured 2026-09-20 against production: every MCP `observation_add`
    // returned 400 ValidationError "path":["content"] — the direct-write
    // surface was dead, not merely untested.
